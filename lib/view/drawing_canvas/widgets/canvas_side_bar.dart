...
import 'package:kidsbook/main.dart';
import 'package:kidsbook/view/drawing_canvas/models/drawing_mode.dart';
import 'package:kidsbook/view/drawing_canvas/models/sketch.dart';
import 'package:kidsbook/view/drawing_canvas/widgets/color_palette.dart';
...
import '../../../paintmain.dart';
import '../../../viewpainting.dart';
...
class CanvasSideBar extends HookWidget {
  ...
  Future<ui.Image> get _getImage async {
    ...
    SharedPreferences sh=await SharedPreferences.getInstance();
      ...
      try {
        final response = await http.get(Uri.parse(sh.getString("image").toString()));
         // response.bodyBytes;

         completer.complete(
         decodeImageFromList( response.bodyBytes),
    );
